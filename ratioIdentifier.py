...
def get_language_type(paragraph):
    ...
    return "Roman Urdu" if non_english_percentage > 30 else "English"
...
def main():
    folder_path = "/home/abdullah-zubair/WheelsMasail/Web Scraping/textPreprocessing/FilteredData_Top4Posts"
